package com.example.completablefuturepractice.blocking.repository;

import com.example.completablefuturepractice.common.repository.ArticleEntity;
...
public class ArticleRepository {
    ...
    public ArticleRepository(){
        articleEntities = List.of(
                ...
                new ArticleEntity("3", "소식3", "내용3", "11000")
                );
    }
